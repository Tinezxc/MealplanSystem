...
public class LoginPage {
    ...
    public LoginPage() {
        ...
        // Background image scaling and setup
        ...
        passwordField.setEchoChar('•'); // Mask initially
        ...
        // Forgot Password label with clickable mouse listener
        ...
        forgotPassword.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                // Open ForgotPassword screen (make sure you have this implemented)
                new ForgotPassword();
            }
        });
        ...
        loginButton.addActionListener(e -> {
            ...
            try {
                ...
                User loggedUser = userDAO.authenticate(email, password);

                if (loggedUser != null) {
                    JOptionPane.showMessageDialog(frame, "Login successful!", "Welcome", JOptionPane.INFORMATION_MESSAGE);
                    frame.dispose();
                    new UserInfo(loggedUser); // Pass logged in User to UserInfo screen
                } else {
        ...
        // Register label and clickable register link
    ...
    // Helper: create circular clipped image for logo
